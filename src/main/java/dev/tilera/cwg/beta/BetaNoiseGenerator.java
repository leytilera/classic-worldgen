...
public class BetaNoiseGenerator extends NoiseGeneratorOctaves implements IBetaNoiseGenerator {
    private BetaPerlinNoise[] generatorCollection;

	public BetaNoiseGenerator(Random var1, int var2) {
        super(null, 0);
		this.octaves = var2;
		this.generatorCollection = new BetaPerlinNoise[var2];

		for(int var3 = 0; var3 < var2; ++var3) {
			this.generatorCollection[var3] = new BetaPerlinNoise(var1);
		}
    ...
    public double[] generateNoiseOctaves(double[] var1, int var2, int var3, int var4, int var5, double var6, double var8, double var10) {
        return this.func_4109_a(var1, var2, var3, var4, var5, var6, var8, var10);
    }

    @Override
    public double[] generateNoiseOctaves(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7, double var8, double var9, double var10) {
        return this.generateNoiseOctaves(var1, (double) var2, (double) var3, (double) var4, var5, var6, var7, var8, var9, var10);
    }
